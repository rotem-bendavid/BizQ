...
const AppointmentSummary = ({ selectedOption ,selectedDate ,selectedTime, clientName, clientMail, clientPhone, specialRequest, onSpecialRequestChange, onClientNameChange, onClientMailChange, onClientPhoneChange, onSubmit }) => {
